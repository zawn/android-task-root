 ...
 *
 */
public class DefaultValuePair implements NameValuePair, Cloneable {
	 ...
	 */
	public DefaultValuePair(final String name, final String value) {

		this(name, value, "iso-8859-1");
	}

	public DefaultValuePair(final String name, final String value, final String encode) {
